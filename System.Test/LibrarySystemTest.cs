...
namespace System.Test
{
    ...
    public sealed class LibrarySystemTest
    {
        ...
        public void AddBook_ShouldHandleUniqueAnddoubleISBN_ReturnExpectedResult(string isbn, string message, bool expectedResult)
        {
            var system = new LibrarySystem();
        ...
        public void RemoveBook_ShouldNotRemoveBookIfBorrowed_ReturnExpectedResult(string isbn, string message, bool expectedResult)
        {
            var system = new LibrarySystem();
        ...
        public void RemoveBook_IfNullOrEmpty_ReturnExpectedResult(string isbn, string message, bool expectedResult)
        {
            var system = new LibrarySystem();
        ...
        public void BorrowBook_BorrowBookIfBookIsAvailable_ReturnExpectedResult(string isbn, string message, bool expectedResult)
        {
            var system = new LibrarySystem();
        ...
        public void BorrowBook_ShouldFailIfBookIsAlreadyBorrowed_ReturnExpectedResult(string isbn, string message, bool expectedResult)
        {
            var system = new LibrarySystem();
        ...
        public void BorrowBook_CheckForValidDate_ReturnExpectedResult(string isbn, string message, bool expectedResult)
        {
            var system = new LibrarySystem();
        ...
        public void ReturnBook_ShoulReturnBookIfBookIsBorrowed_ReturnExpectedResult(string isbn, string message, bool expectedResult)
        {
            var system = new LibrarySystem();
        ...
        public void ReturnBook_ShouldFailIfBookWasNotBorrowed_ReturnExpectedResult(string isbn, string message, bool expectedResult)
        {
            var system = new LibrarySystem();
        ...
        public void CalculateLateFee_ShouldReturnCorrectFee_ReturnExpectedResult(string isbn, int daysLate, string message, int expectedResult)
        {
            var system = new LibrarySystem();
        ...
        public void CalculateLateFee_ShouldReturnZeroIfBookNotFound_ReturnExpectedResult(string isbn, int daysLate, string message, int expectedResult)
        {
            var system = new LibrarySystem();
        ...
        public void CalculateLateFee_ShouldReturnZeroIfDaysLateIsZeroOrNegative_ReturnExpectedResult(string isbn, int daysLate, string message, int expectedResult)
        {
            var system = new LibrarySystem();
        ...
        public void IsBookOverdue_ShouldReturnTrueIfLoanPeriodPassed_ReturnExpectedResult(string isbn, int borrowedDaysAgo, int borrowPeriod, string message, bool expectedResult)
        {
            var system = new LibrarySystem();
        ...
        public void IsBookOverdue_ShouldReturnFalseIfLoanPeriodNotPassed_ReturnExpectedResult(string isbn, int borrowedDaysAgo, int borrowPeriod, string message, bool expectedResult)
        {
            var system = new LibrarySystem();
        ...
        public void IsBookOverdue_ShouldReturnFalseIfBookIsNotBorrowed_ReturnExpectedResult(string isbn, int borrowPeriod, string message, bool expectedResult)
        {
            var system = new LibrarySystem();
